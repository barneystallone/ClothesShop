    ...
    return (
        ...
        >
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <Button type='submit' className="submit-btn">Đăng nhập ngay</Button>

                <div className="login-signup">Chưa có tài khoản? <span onClick={toSignUp}>Tạo tài khoản</span></div>
            </form>
