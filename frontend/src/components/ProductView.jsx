    ...
    return (
        <div className="product__wrap" >
            ...
            <div className="product__wrap__inner bottom">
                {
                    !props?.modal ? <ProductDescription /> : null
                }
            ...
            <div className="tab-container">
                <div className="product-description">
                    ...
                    <div className="product-description__content">
                        ...
                        <p><strong>* HƯỚNG DẪN CHỌN SIZE CHO BẠN</strong></p>

                        <p>- Free size &lt;62kg</p>

                        <p>Hướng dẫn chọn size ở trên chỉ mang tính chất tham khảo tương đối, tuỳ vào chiều cao và số đo cơ thể mà bạn có thể thay đổi&nbsp;để chọn đúng size sản phẩm phù hợp.</p>
